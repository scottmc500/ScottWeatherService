...
dev: ## Start all services in development mode
	...
	@echo "Calendar Service: http://localhost:8002"
	@echo "Weather Service: http://localhost:8003"
...
health: ## Check health of all services
	...
	@echo "Core Service:"
	@curl -s http://localhost:8001/health || echo "$(RED)Core Service: DOWN$(NC)"
	@echo "Calendar Service:"
	@curl -s http://localhost:8002/health || echo "$(RED)Calendar Service: DOWN$(NC)"
	@echo "Weather Service:"
	@curl -s http://localhost:8003/health || echo "$(RED)Weather Service: DOWN$(NC)"
	@echo "Frontend:"
...
quick-start: ## Quick start for development
	...
	@echo "$(GREEN)  Core Service:    http://localhost:8001$(NC)"
	@echo "$(GREEN)  Calendar Service: http://localhost:8002$(NC)"
	@echo "$(GREEN)  Weather Service:  http://localhost:8003$(NC)"
	@echo "$(GREEN)  Redis:           localhost:6379$(NC)"
	@echo "$(GREEN)  MongoDB:         localhost:27017$(NC)"
	@echo "$(GREEN)  MongoDB Express: http://localhost:8081 (admin/password)$(NC)"
	@echo ""
